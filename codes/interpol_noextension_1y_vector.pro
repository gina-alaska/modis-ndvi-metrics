...
pro interpol_noextension_1y_vector,  mid_year_cb, mid_year_bn,threshold,snowcld,v_interp,v_bq_interp, v_bname_interp,ratio, mid_stnum,mid_ednum,flg_metrics
...
cutoff_interp,mid_year_cb,mid_year_g,flg_metrics  ; cutoff_interp_ver10, first change fill value as 100, then cut off negative,
